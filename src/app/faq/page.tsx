...
export default function FAQPage() {
  ...
  return (
    <div className="bg-slate-50 min-h-screen text-slate-900 selection:bg-blue-100 selection:text-blue-900 pb-20">
      ...
      {/* --- HERO HEADER --- */}
      <div className="bg-white border-b border-slate-200 pt-32 pb-16 px-6 relative overflow-hidden">
        {/* Background Decor */}
        <div className="absolute top-0 right-0 w-[500px] h-[500px] bg-blue-50 rounded-full blur-[100px] opacity-60 translate-x-1/3 -translate-y-1/3 pointer-events-none"></div>
        <div className="absolute bottom-0 left-0 w-[300px] h-[300px] bg-indigo-50 rounded-full blur-[80px] opacity-40 -translate-x-1/3 translate-y-1/3 pointer-events-none"></div>
      ...
      <div className="max-w-3xl mx-auto px-6 py-12 space-y-4">
            ...
            >
              ...
              <div className={`grid transition-[grid-template-rows] duration-300 ease-in-out ${isOpen ? "grid-rows-[1fr]" : "grid-rows-[0fr]"}`}>
                <div className="overflow-hidden">
                  <div className="p-6 pt-0 pl-[5.5rem] pr-8 text-slate-600 leading-relaxed text-base">
                    {faq.answer}
                  </div>
                </div>
              </div>
        ...
        {/* --- CONTACT BOX --- */}
        <div className="mt-16 relative group overflow-hidden rounded-3xl">
