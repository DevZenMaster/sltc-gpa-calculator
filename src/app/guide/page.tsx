  ...
  return (
    <div className="bg-white dark:bg-[#030303] min-h-screen text-slate-900 dark:text-slate-100 selection:bg-blue-100 selection:text-blue-900 pb-24 transition-colors duration-500">
      ...
      <div className="relative pt-32 pb-20 px-6 overflow-hidden border-b border-slate-100 dark:border-white/5">
        ...
        <div className="max-w-4xl mx-auto text-center relative z-10">
          ...
          <p className="text-xl text-slate-500 dark:text-slate-400 max-w-2xl mx-auto font-medium italic leading-relaxed">
            Technical documentation for the Logic Engine powering your academic roadmap.
          </p>
        </div>
      </div>
      ...
      <div className="max-w-5xl mx-auto px-6 py-20 space-y-24">
        ...
        {/* --- SECTION 1: THE ALGORITHM VISUAL --- */}
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center mt-12">
            <div className="space-y-6">
              <p className="text-lg text-slate-500 dark:text-slate-400 font-medium leading-relaxed">
                The GPA is a <span className="text-slate-900 dark:text-white font-black italic uppercase">Weighted Index</span>. Unlike a simple average, modules with higher credit values exert a proportionately greater influence.
              </p>
              <div className="p-6 rounded-3xl bg-slate-50 dark:bg-white/[0.02] border border-slate-200 dark:border-white/10 space-y-4">
                <div className="flex items-start gap-4">
                  ...
                  <p className="text-sm font-medium text-slate-600 dark:text-slate-400 lowercase">
                    GPAs are calculated by summing the Grade Point (GP) × Credits (C) for each module and dividing by the total credits attempted.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="relative group p-1 w-full max-w-md mx-auto">
              ...
              <div className="relative bg-white dark:bg-slate-900 border border-slate-200 dark:border-white/10 p-10 rounded-[2.5rem] text-center shadow-2xl">
                 <div className="text-[10px] font-black uppercase tracking-[0.4em] text-slate-400 mb-6 font-mono">Algorithm Output</div>
                 ...
                 <div className="text-[10px] font-bold text-slate-400 mt-6 italic uppercase tracking-[0.2em]">Validated Academic Statement</div>
              </div>
            </div>
          </div>
        </section>
        ...
        <section>
          <div className="flex items-center gap-4 mb-10">
            ...
            <h2 className="text-3xl font-black uppercase tracking-tighter italic leading-none">Grading Matrix</h2>
          </div>

          

          <div className="rounded-[3rem] border border-slate-100 dark:border-white/5 bg-white dark:bg-white/[0.01] overflow-hidden shadow-2xl mt-8">
            <table className="w-full text-left">
              <thead>
                <tr className="bg-slate-50 dark:bg-white/5 text-[10px] font-black text-slate-400 uppercase tracking-[0.3em]">
                  ...
                  <th className="p-8">Value (GP)</th>
                  <th className="p-8 hidden md:table-cell text-right">Classification</th>
                </tr>
              </thead>
              <tbody className="divide-y divide-slate-100 dark:divide-white/5 text-sm font-black uppercase tracking-widest">
                {[
                  { g: "A+", p: "4.00", d: "Superior", color: "text-blue-600" },
                  { g: "A",  p: "4.00", d: "Excellent", color: "text-blue-600" },
                  { g: "A-", p: "3.70", d: "Very Good", color: "text-indigo-600" },
                  { g: "B+", p: "3.30", d: "Good", color: "text-emerald-600" },
                  { g: "C",  p: "2.00", d: "Pass", color: "text-slate-400" },
                  { g: "E",  p: "0.00", d: "Fail", color: "text-red-600" },
                ].map((row, i) => (
        ...
        <section>
          <div className="flex items-center gap-4 mb-10">
            ...
            <h2 className="text-3xl font-black uppercase tracking-tighter italic leading-none">Honours Roadmap</h2>
          </div>

          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            {[
              { title: "First Class", gpa: "3.70+", icon: <Zap size={20}/>, theme: "bg-blue-600" },
              { title: "Second Upper", gpa: "3.30+", icon: <Target size={20}/>, theme: "bg-indigo-600" },
            ].map((tier) => (
              <div key={tier.title} className="p-10 rounded-[3rem] bg-white dark:bg-white/[0.02] border border-slate-100 dark:border-white/10 shadow-xl group hover:-translate-y-2 transition-all duration-500">
                <div className="flex justify-between items-start mb-8">
                   <div className={`p-4 rounded-2xl text-white shadow-xl ${tier.theme} group-hover:scale-110 transition-transform`}>
                      {tier.icon}
                   </div>
                   <div className="text-right">
                      <div className="text-[10px] font-black uppercase tracking-widest text-slate-400 mb-1">Target</div>
                      <div className="text-2xl font-black italic tracking-tighter text-blue-600">{tier.gpa}</div>
                   </div>
                </div>
                <h3 className="text-2xl font-black uppercase tracking-tighter italic">{tier.title}</h3>
              </div>
            ))}
          </div>
        </section>
        ...
        <div className="p-16 rounded-[4rem] bg-slate-900 dark:bg-blue-600 text-center text-white relative overflow-hidden group shadow-3xl">
           ...
           <div className="relative z-10 space-y-6">
              <h2 className="text-4xl md:text-6xl font-black tracking-tighter uppercase italic leading-none">Ready to <br /> <span className="text-blue-400 dark:text-slate-950">Architect?</span></h2>
              <div className="pt-6">
                <Link 
                  href="/calculator" 
